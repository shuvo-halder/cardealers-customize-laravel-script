...
<body>
    ...
    @if (Route::is('home'))
        <header
            class="header {{ Session::get('selected_theme') != 'theme_three' ? 'header-two' : '' }}  {{ Session::get('selected_theme') == 'theme_two' ? 'header-three' : '' }}">
        @else
                                ...
                                <a class=" btn-secondary dropdown-toggle" href="#" role="button"
                                    ...
                                    <span>
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <ellipse cx="11.0001" cy="11" rx="4" ry="10"
                                                stroke-width="1.5" />
                                            <path
                    ...
                    <div class="header-right-login-btn">
                        @auth('web')
                            <a href="{{ route('user.dashboard') }}"
                                class="@if (Route::is('home')) {{ Session::get('selected_theme') == 'theme_three' ? 'thm-btn' : 'thm-btn-two' }} @else thm-btn-two @endif">
                                <span>
                                    <svg width="14" height="18" viewBox="0 0 14 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <ellipse cx="6.99676" cy="13.8885" rx="6.22222" ry="3.11111"
                                ...
                                <a href="{{ route('home') }}">
                                    @if (Route::is('home'))
                                        @if (Session::get('selected_theme') == 'theme_two')
                                            <img src="{{ getImageOrPlaceholder($setting->home2_logo2, '170x46') }}"
                                                alt="logo">
                                        @elseif (Session::get('selected_theme') == 'theme_three')
                                            <img src="{{ getImageOrPlaceholder($setting->home3_logo2, '170x46') }}"
                                                alt="logo">
                                        @else
                                            <img src="{{ getImageOrPlaceholder($setting->logo, '170x46') }}"
                                                alt="logo">
                                        @endif
                                    @else
                                        <img src="{{ getImageOrPlaceholder($setting->inner_logo, '170x46') }}"
                                            alt="logo">
                                    @endif
                                </a>
                            </div>
                            ...
                            <div class="menu">
                                <ul>
                                    @if ($setting->selected_theme == 'all_theme')
                                        <li><a href="{{ route('home') }}">{{ __('translate.Home') }} <i
                                                    class="fa-solid fa-angle-down"></i> </a>

                                            <ul class="sub-menu">
                                                <li><a href="{{ route('home', ['theme' => 'one']) }}">{{ __('translate.Home-01') }}
                                                    </a> </li>
                                                <li><a href="{{ route('home', ['theme' => 'two']) }}">{{ __('translate.Home-02') }}
                                                    </a> </li>
                                                <li><a href="{{ route('home', ['theme' => 'three']) }}">{{ __('translate.Home-03') }}
                                                    </a> </li>
                                            </ul>
                                        </li>
                                    @else
                                    ...
                                    <li><a href="javascript:;">{{ __('translate.Pages') }} <i
                                                class="fa-solid fa-angle-down"></i> </a>
                                        <ul class="sub-menu">

                                            <li><a
                                                    href="{{ route('pricing-plan') }}">{{ __('translate.Pricing Plan') }}</a>
                                            </li>

                                            <li><a
                                                    href="{{ route('terms-conditions') }}">{{ __('translate.Terms and Conditions') }}</a>
                                            </li>
                        ...
                        <div class="nav-btn">
                            ...
                            @if (Route::is('home'))
                                @if (Session::get('selected_theme') == 'theme_one')
                                    <a href="{{ route('user.select-car-purpose') }}"
                                        class="thm-btn-two">{{ __('translate.Add Car') }}</a>
                                @elseif (Session::get('selected_theme') == 'theme_two')
                                    <a href="{{ route('user.select-car-purpose') }}"
                                        class="thm-btn-thr">{{ __('translate.Add Car') }}</a>
                                @elseif (Session::get('selected_theme') == 'theme_three')
                                    <a href="{{ route('user.select-car-purpose') }}"
                                        class="thm-btn">{{ __('translate.Add Car') }}</a>
                                @endif
                            @else
                                <a href="{{ route('user.select-car-purpose') }}"
                                    class="thm-btn-two">{{ __('translate.Add Car') }}</a>
    ...
    <header
        class="mobile-header @if (Route::is('home')) {{ Session::get('selected_theme') == 'theme_two' ? 'two' : '' }} {{ Session::get('selected_theme') == 'theme_three' ? 'three' : '' }} @endif">
    ...
    <aside id="offcanvas-nav">
        ...
        <nav
            class="m-nav @if (Route::is('home')) {{ Session::get('selected_theme') == 'theme_two' ? 'm-nav-two' : '' }} {{ Session::get('selected_theme') == 'theme_three' ? 'm-nav-three' : '' }} @endif ">
            ...
            <ul class="nav-links">
                <li class="dropdown">
                    ...
                    <ul class="d-menu">
                        <li><a href="{{ route('home', ['theme' => 'one']) }}">{{ __('translate.Home-01') }} </a>
                        </li>
                        <li><a href="{{ route('home', ['theme' => 'two']) }}">{{ __('translate.Home-02') }} </a>
                        </li>
                        <li><a href="{{ route('home', ['theme' => 'three']) }}">{{ __('translate.Home-03') }} </a>
                        </li>
                    </ul>
                </li>
    ...
    @if (Route::is('home'))
        <footer
            class="footer {{ Session::get('selected_theme') == 'theme_two' ? 'footer-three' : '' }} {{ Session::get('selected_theme') == 'theme_one' ? 'footer-two' : '' }}">
        @else
            ...
            <div class="col-lg-8 col-p-0" data-aos="fade-left" data-aos-delay="100">
                <div class="newsletter-sarch-box-main-item">
                    <div class="newsletter-sarch-box-main">
                        <form action="{{ route('newsletter-request') }}" class="newsletter-sarch-box"
                            method="POST">
                            @csrf
                            ...
                            @if (Route::is('home'))
                                <button type="submit"
                                    class="{{ Session::get('selected_theme') == 'theme_two' ? 'thm-btn-thr' : '' }} {{ Session::get('selected_theme') == 'theme_one' ? 'thm-btn-two' : '' }} {{ Session::get('selected_theme') == 'theme_three' ? 'thm-btn' : '' }}">{{ __('translate.Subscribe') }}</button>
                            @else
    ...
    @if ($cookie_consent->status == 1)
        ...
        <div class="common-modal cookie_consent_modal d-none">
            ...
            <div class="common-modal-btn">
                <a href="javascript:;"
                    class="thm-btn-two cookie_consent_accept_btn">{{ __('translate.Accept') }}</a>
            </div>
    ...
    @if (Route::is('home'))
        @if (Session::get('selected_theme') == 'theme_two')
            <div class="back-to-top">
                <span>
                    <svg width="39" height="75" viewBox="0 0 39 75" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
