...
<style>
    ...
    .inner-banner {
    background-image: url("{{ asset($breadcrumb) }}");
    ...
    .inventory-details-top-taitel {
    margin-bottom: 20px;
    }
    
    .inventory-details-top-taitel h5 {
    font-size: 16px;
    color: #333;
    margin-bottom: 5px;
    }
    
    .inventory-details-top-taitel span {
    display: block;
    font-size: 14px;
    color: #999;
    }
    
    .inventory-details-taitel {
    font-size: 24px;
    color: #333;
    line-height: 36px;
    margin-bottom: 25px;
    ...
    .inventory-details-slick-img img {
    width: 100%;
    height: 300px;
    object-fit: cover;
    border-radius: 5px;
    ...
    .inventory-details-slick-nav img {
    width: 100px;
    height: 70px;
    object-fit: cover;
    margin: 5px;
    ...
    .inventory-details-thumb {
    margin-top: 40px;
    }
    
    .inventory-details-thumb img {
    width: 100%;
    border-radius: 5px;
    }
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-sm-6 col-md-12">
                            <div class="inventory-details-top-taitel">
                                <h5 style="color: #fff;">{{ __('translate.Brand') }} : {{ $car?->brand?->name }}</h5>
                                <span></span>
                                <h5 style="color: #fff;">{{ __('translate.Views') }} : {{ $car->total_view }}</h5>
                            </div>

                            <h2  style="color: #fff;" class="inventory-details-taitel">{{ html_decode($car->title) }}</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="inventory-details-slick-for">
                                ...
                                <div class="inventory-details-slick-img">
                                        ...
                                        <img src="{{ asset($car->thumb_image) }}" alt="ing">
                                </div>
                    ...
                    data-aos-delay="100">
                        <div class="accordion-item">
                            ...
                            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
                                ...
                                <div  style="background-color:#2b2b2b; color:#fff;" class="accordion-body">
                            ...
                            <div id="panelsStayOpen-collapsefour" class="accordion-collapse collapse show"
                                ...
                                <div style="background-color:#2b2b2b; color:#fff;" class="accordion-body">
                                    ...
                                    <span class="inventory-details-vedio">
                                        <img src="{{ asset($car->video_image) }}" width="80%" alt="img">
                                        ...
                                        <form method="POST" action="{{ route('user.store-review') }}">
                                            ...
                                            <div class="form-item">
                                                <div class="form-inner">
                                                    ...
                                                    <textarea style="background-color:#2b2b2b; color:#fff;" name="comment" class="form-control" id="review" rows="5" placeholder="{{ __('translate.Write here') }}"></textarea>
                                                </div>
                                            ...
                                            <button type="submit" class="btn btn-dark btn--regular scale--3 py-2 mt-2">{{ __('translate.Submit Review') }}</button>
                    ...
                    <div class="auto-sales-item">
                        ...
                        <div  class="auto-sales-logo">
                                <a href="{{ route('dealer', $dealer->username) }}">
                                    <img style="border-radius: 1px solid #fff;" src="{{ getImageOrPlaceholder($dealer->image, '80x80') }}" alt="logo"></a>
                            </div>
                            ...
                            <form method="POST" action="{{ route('send-message-to-dealer', $dealer->id) }}">
                                ...
                                <div class="auto-sales-form">
                                    ...
                                    <div class="auto-sales-form-item">
                                        <input style="background-color: #2b2b2b;color:#fff;" type="text" class="form-control" id="exampleFormControlInput3"
                                            placeholder="{{ __('translate.Name') }} *" name="name" value="{{ old('name') }}">
                                    </div>
                                    <br>
                                    <div class="auto-sales-form-item">
                                        <input style="background-color: #2b2b2b;color:#fff;" type="email" class="form-control" id="exampleFormControlInput4"
                                            placeholder="{{ __('translate.Email') }} *" name="email" value="{{ old('email') }}">
                                    </div>
                                    <br>
                                    <div class="auto-sales-form-item">
                                        <input style="background-color: #2b2b2b;color:#fff;" type="text" class="form-control" id="exampleFormControlInput5"
                                            placeholder="{{ __('translate.Phone') }}" name="phone" value="{{ old('phone') }}">
                                    </div>
                                    <br>
                                    <div class="auto-sales-form-item">
                                        <input style="background-color: #2b2b2b;color:#fff;" type="text" class="form-control" id="exampleFormControlInpu6"
                                            placeholder="{{ __('translate.Subject') }} *" value="{{ old('subject') }}" name="subject">
                                    </div>
                                    <br>
                                    <div class="auto-sales-form-item">
                                        <textarea style="background-color: #2b2b2b;color:#fff;" class="form-control" id="exampleFormControlTextarea11" rows="3"
                                    ...
                                    @endif
                                        <br>
                                    <button type="submit" class="btn btn-dark btn--regular scale--3 py-2 mt-2">{{ __('translate.Send Message') }}</button>
                                </div>
                            </form>
                        </div>
                        <br>
                                ...
                                <div class="auto-lone-form">
                                    <div class="auto-lone-form-item">
                                        <label for="loan_amount" class="form-label">{{ __('translate.Loan Amount') }}
                                            <span>*</span></label>
                                        <input style="background-color: #2b2b2b;color:#fff;" type="text" class="form-control" id="loan_amount"
                                    ...
                                    <div class="auto-lone-form-item">
                                        <label for="interest_rate" class="form-label">{{ __('translate.Interest Rate') }}
                                            <span>*</span></label>
                                        <input style="background-color: #2b2b2b;color:#fff;" type="text" class="form-control" id="interest_rate"
                                    ...
                                    <div class="auto-lone-form-item">
                                        <label for="total_year" class="form-label">{{ __('translate.Loan Tern in Year') }}
                                            <span>*</span></label>
                                        <input style="background-color: #2b2b2b;color:#fff;" type="date" class="form-control" id="total_year"
                                    ...
                                    <div class="auto-lone-form-btn">
                                        <button id="calculate_btn" type="button" class="btn btn-dark btn--regular scale--3 py-2 mt-2">{{ __('translate.Loan Calculate') }}</button>
                                        <button type="button" class="btn btn-dark btn--regular scale--3 py-2 mt-2" id="reset_btn">
                                            <span>
